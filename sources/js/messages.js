(function (app) {
  ...
  function alert (msg) {
    // si mostra la notifica, e sfondo grigio che impedisce di avanzare se non si clicca ok
    _setType("alert");

  }

  function log (msg) {
    // notifica senza pulsanti, che si auto nasconde dopo un pochino
    // con X di chiusura su desktop
    _setType("log");

  }

  function success (msg) {
    // notifica verde con icona, che si auto nasconde dopo poco
    _setType("success");

  }

  function error (msg) {
    // notifica rossa con icona, che si auto nasconde dopo poco
    _setType("error");

  }

  function confirm (msg, mandatory) {
  ...
  // ovviamente tutti posso anche interagire con tastiera, invio ed escape
...
(function(app) {
  ...
  var alert_outer_id = 'messages-alert-outer';
  var alert_inner_id = 'messages-alert-inner';
  var alert_text_id = 'messages-alert-text';
  var confirm_outer_id = 'messages-confirm-outer';
  var confirm_inner_id = 'messages-confirm-inner';
  var confirm_background_id = 'messages-confirm-background';
  var confirm_yes_id = 'messages-confirm-yes';
  var confirm_no_id = 'messages-confirm-no';
  var confirm_text_id = 'messages-confirm-text';
  var confirm_yes_text_id = 'messages-confirm-yes-text';
  var confirm_no_text_id = 'messages-confirm-no-text';
  var input_outer_id = 'messages-input-outer';
  var input_inner_id = 'messages-input-inner';
  var input_background_id = 'messages-input-background';
  var input_div_id = 'messages-input-div';
  var input_field_id = 'messages-input-field';
  var input_yes_id = 'messages-input-yes';
  var input_no_id = 'messages-input-no';
  var input_text_id = 'messages-input-text';
  var input_yes_text_id = 'messages-input-yes-text';
  var input_no_text_id = 'messages-input-no-text';
  ...
  // Scroll disable and enable for messages.confirm and messages.input
  ...
  function scroll_enable() {
    ...
    // Attach messages to the body element
    ...
    function alert_show(type, message, seconds) {
        ...
        // Set messages type (background color)
        switch(type) {
            case 1:
    ...
    // Hide messages.confirm on background click
    ...
    // Hide messages.input on background click
